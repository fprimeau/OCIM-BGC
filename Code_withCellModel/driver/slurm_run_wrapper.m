...
fprintf('Reoptimizing P-dependent model using the SetUp input fields from the Nature paper (Wang et al., 2023) using initial guess on CO and params from from hojongs previous run.  No smoothing \n\n')
