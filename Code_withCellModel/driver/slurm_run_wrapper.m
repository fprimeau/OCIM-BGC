...
diary logs/optPCO_GM15_v2_WOA18_smoooth_rmoutliers_NPPc2p117.out
%fprintf('----------------------------------- \n\n')
dbstop if error
date_start = datetime('now');
fprintf('Start Date: %s\n',date_start)
fprintf('Reoptimizing GM15 C2P model using the SetUp input processing from the Nature paper (Wang et al., 2023) (smooth WOA PO4 and Temp obs; remove arctic docraw,alkraw,dicraw ; remove med docraw, alkraw, dicraw, po4raw, o2raw. ; rmoutliers from docraw, po4raw, dicraw, alkraw, o2raw); using WOA18 data files created in make_datafile_24layer/bin_WOA_nut.m (units converted using constant seawater density); using initial guess on CO from from hojongs previous run. initial parameter values from Hojongs previous run. NPP p2c conversion = 1/117 \n\n')
