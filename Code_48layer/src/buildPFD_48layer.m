function [PFdiv,Gout,Hout] = buildPFD_48layer(par,Ptype)
%[PFdiv] = buildPFD_48layer(M3d,grd,par,Ptype)
%[PFdiv,grad] = buildPFD_48layer(M3d,grd,par,Ptype)
%[PFdiv,grad,hess] = buildPFD_48layer(M3d,grd,par,Ptype)
%
% INPUT:
...
%
    ...
    dAt = par.dAt;
    dVt = par.dVt;
    [DIV,IU,M,MSK,iwet] = mkOperators(M3d,grd,dAt,dVt);
...
function [DIV,IU,M,MSK,iwet] = mkOperators(M3d,grd,dAt,dVt);
