function [PFdiv,Gout,Hout] = buildPFD(M3d,grd,parm,Ptype)
...
if ( strcmp(Ptype,'POP') | stcmp(Ptype,'POC') )
    ...
    % mimic a Martin curve flux attenuation profile (see Kriest and Oschelies 2008 in Biogeosciences)
