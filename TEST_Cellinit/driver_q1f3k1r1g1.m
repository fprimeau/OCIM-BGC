...
fprintf(['\n' 'NOTE: test cell model initial values \n' ...
	...
	'sigma fixed at zero, \n'...
	'beta fixed at 0.5 \n'...
	'alpha =on initialized at 3.78e-5'
	'Q10Photo on initial = 1 \n'...
	'fStorage initialized at 10 (testing starting from an unreasonably large value, to see if it decreases)\n'...
	'dynamicP = off \n'])
...
VerName = 'q1f3k1r1g1_'; 		% optional version name. leave as an empty character array
