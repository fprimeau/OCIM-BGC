...
fprintf(['\n' 'NOTE: test cell model initial values \n' ...
	...
	'beta fixed at 0.5 \n'...
	'alpha = 3.78e-5'
	'Q10Photo on initial = 2 \n'...
	'fStorage initialized at 1 \n'...
	'PStor_rCutoff initialized at 10 \n'...
	'dynamicP = off \n'])
...
VerName = 'a0q2f2k1r2g1_'; 		% optional version name. leave as an empty character array
...
par.fxhatload = '/DFS-L/DATA/primeau/meganrs/OCIM_BGC_OUTPUT/MSK91/testCellinit/a0q2f2k1r2g1_CTL_He_PCCell_DOC0.25_DOP0_xhat.mat';
