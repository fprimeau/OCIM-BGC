function [f, fx, fxx] = neglogpost(x, par,par_old)
global iter
on = true; off = false;
if iter <= 10
  % reset parameters if they are too large/small;
  x = reset_par(x, par, par_old);
  par.p0 = x;
end
