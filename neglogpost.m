...
if (par.Cmodel == off & par.Omodel == off & par.Simodel == off)
    save(par.fname,'DIP','DOP','POP')
    %
elseif (par.Cmodel == on & par.Omodel == off & par.Simodel == off)
    save(par.fname,'DIC','POC','DOC','CaC','DIP','DOP','POP')
    %
elseif (par.Cmodel == on & par.Omodel == on & par.Simodel == off)
    save(par.fname,'DIC','POC','DOC','CaC','DIP','DOP','POP','O2')
    %
elseif (par.Cmodel == on & par.Omodel == off & par.Simodel == on)
    save(par.fname,'DIC','POC','DOC','CaC','DIP','DOP','POP','SIL','DSI')
    %
elseif (par.Cmodel == on & par.Omodel == on & par.Simodel == on)
    save(par.fname,'DIC','POC','DOC','CaC','DIP','DOP','POP','O2','SIL','DSI')
end 
% calculate gradient
%% +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
if (nargout > 1)
