function [par,Si,Six,Sixx] = eqSicycle(x, par)
    ...
    if (par.optim == off)
        ...
        if (par.opt_kappa_dp == on)
            tmp = [-d0(Gx(:,pindx.lkappa_dp))*SIL.*Si2C;...
                   d0(Gx(:,pindx.lkappa_dp))*SIL.*Si2C];
            
            Six(:,pindx.lkappa_dp) = mfactor(FD, tmp);
        end
    ...
    if (par.optim == off)
        ...
        if (par.opt_sigma & par.opt_kappa_dp)
            tmp = [-d0(Gxx(:,kk))*SIL.*Si2C; ...
                   d0(Gxx(:,kk))*SIL.*Si2C] + ...
                  [-d0(Gx(:,pindx.lsigma))*SILx(:,pindx.lkappa_dp).*Si2C;...
                   d0(Gx(:,pindx.lsigma))*SILx(:,pindx.lkappa_dp).*Si2C] + ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lsigma).*Si2C;...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lsigma).*Si2C];
        ...
        if (par.opt_kappa_dp == on)
            tmp = [-d0(Gxx(:,kk))*SIL.*Si2C; ...
                   d0(Gxx(:,kk))*SIL.*Si2C] + ...
                  2*[-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lkappa_dp).*Si2C;...
                     d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lkappa_dp).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_bP_T == on)
            tmp = [-d0(Gxx(:,kk))*SIL.*Si2C; ...
                   d0(Gxx(:,kk))*SIL.*Si2C] + ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.bP_T).*Si2C;...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.bP_T).*Si2C]+...
                  [-d0(Gx(:,pindx.bP_T))*SILx(:,pindx.lkappa_dp).*Si2C;...
                   d0(Gx(:,pindx.bP_T))*SILx(:,pindx.lkappa_dp).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_bP == on)
            tmp = [-d0(Gxx(:,kk))*SIL.*Si2C; ...
                   d0(Gxx(:,kk))*SIL.*Si2C] + ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbP).*Si2C;...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbP).*Si2C]+...
                  [-d0(Gx(:,pindx.lbP))*SILx(:,pindx.lkappa_dp).*Si2C;...
                   d0(Gx(:,pindx.lbP))*SILx(:,pindx.lkappa_dp).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_alpha == on)
            tmp = [-d0(Gxx(:,kk))*SIL.*Si2C; ...
                   d0(Gxx(:,kk))*SIL.*Si2C] + ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lalpha).*Si2C;...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lalpha).*Si2C]+...
                  [-d0(Gx(:,pindx.lalpha))*SILx(:,pindx.lkappa_dp).*Si2C;...
                   d0(Gx(:,pindx.lalpha))*SILx(:,pindx.lkappa_dp).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_beta == on)
            tmp = [-d0(Gxx(:,kk))*SIL.*Si2C; ...
                   d0(Gxx(:,kk))*SIL.*Si2C] + ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbeta).*Si2C;...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbeta).*Si2C]+...
                  [-d0(Gx(:,pindx.lbeta))*SILx(:,pindx.lkappa_dp).*Si2C;...
                   d0(Gx(:,pindx.lbeta))*SILx(:,pindx.lkappa_dp).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_dsi == on)
            tmp = dsi*[0*DSI; ...
                       -(PFD_dsi)*DSIx(:,pindx.lkappa_dp)]+ ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.ldsi).*Si2C; ...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.ldsi).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_at == on)
            tmp = at*[k_at*DSIx(:,pindx.lkappa_dp); ...
                      -(k_at+PFD_at)*DSIx(:,pindx.lkappa_dp)]+ ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lat).*Si2C; ...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lat).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_bt == on)
            tmp = bt*[k_bt*DSIx(:,pindx.lkappa_dp); ...
                      -(k_bt+PFD_bt)*DSIx(:,pindx.lkappa_dp)]+ ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbt).*Si2C; ...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbt).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_aa == on)
            tmp =  [-d0(Gxx(:,kk))*SIL; ...
                    d0(Gxx(:,kk))*SIL] + ...
                   [-d0(G*SILx(:,pindx.lkappa_dp))*dSi2Cdaa; ...
                    d0(G*SILx(:,pindx.lkappa_dp))*dSi2Cdaa]+ ...
                   [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.aa).*Si2C; ...
                    d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.aa).*Si2C];
        ...
        if (par.opt_kappa_dp == on & par.opt_bb == on)
            tmp = [-d0(Gxx(:,kk))*SIL; ...
                   d0(Gxx(:,kk))*SIL] + ...
                  bb*[-d0(G*SILx(:,pindx.lkappa_dp))*dSi2Cdbb; ...
                      d0(G*SILx(:,pindx.lkappa_dp))*dSi2Cdbb]+ ...
                  [-d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbb).*Si2C; ...
                   d0(Gx(:,pindx.lkappa_dp))*SILx(:,pindx.lbb).*Si2C];
