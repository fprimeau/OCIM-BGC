...
% NOTE: Temperature increase by 5C
...
par.fxhatload = '/DFS-L/DATA/primeau/meganrs/OCIM_BGC_OUTPUT/C2P_paper_optC/optC_Cell_CTL_He_PCCell_DOC0.25_DOP0_xhat.mat';
%'/DFS-L/DATA/primeau/meganrs/OCIM_BGC_OUTPUT/MSK91/testCellinit/a0q1f1k1r0g1_CTL_He_PCCell_DOC0.25_DOP0_xhat.mat' ;
%par.fload = '/DFS-L/DATA/primeau/meganrs/OCIM_BGC_OUTPUT/MSK91/testCellinit/q1f2k1r1g2_CTL_He_PCCell_DOC0.25_DOP0_xhat.mat' ;

fprintf('load parameters from run: %s \n',par.fxhatload)

VerName = 'Tup5Cv2_Cell_'; 		% optional version name. leave as an empty character array
...
elseif isunix
	%output_dir = sprintf('/DFS-L/DATA/primeau/meganrs/OCIM_BGC_OUTPUT/C2P_paper/futureproj/');
...
nip = length(x0);
	...
	if (par.optim)
		...
		if (par.Cellmodel == on)
			tic
			[par, C2P, C2Px, C2Pxx, C2Ppxx] = eqC2Puptake(x0, par, model); % this line replaces the rest of this section
			par.C2Px = C2Px;
			par.C2Pxx = C2Pxx;
			par.C2Ppxx = C2Ppxx;
