...
fprintf('NOTE: Temperature increase by 5C; in v2 temperature increase only applies to C2P, so there should be no change from optimal solution \n')
...
VerName = 'Tup5Cv2_GM15_'; 		% optional version name. leave as an empty character array
