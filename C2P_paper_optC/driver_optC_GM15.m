...
fprintf(['\n' 'NOTE: optimize C cycle with GM15 function for C:P \n' ...
...
VerName = 'optC_GM15_'; 		% optional version name. leave as an empty character array
...
par.opt_R_Si  = off ;
par.opt_rR    = on ; %
par.opt_cc    = on ; %always off if cell model on
