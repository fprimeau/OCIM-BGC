            ...
            for jk = jj:npx
                ...
                if (par.opt_sigma == on)
                    ...
                    if (jj == jk & jj == pindx.lsigma)
						if (par.Cellmodel)
							GC2Px = G*C2Px(:,jj) + d0(Gx(:,jj))*C2P;
							GC2Pxx = d0(Gxx(:,kk))*C2P + G*C2Ppxx(:,kk) + 2*d0(Gx(:,jj))*C2Px(:,jj);
							tmp = sigma*[RR*G*C2P + 2*RR*GC2Px; ...
                                     -G*C2P - 2*GC2Px;...
                                      G*C2P + 2*GC2Px;...
                                     -RR*G*C2P - 2*RR*GC2Px; ...
                                     2*RR*G*C2P + 2*2*RR*GC2Px] + ...
                              		[-(I+(1-sigma)*RR)*GC2Pxx; ...
                               		(1-sigma)*GC2Pxx; ...
                               		sigma*GC2Pxx; ...
                               		(1-sigma)*RR*GC2Pxx; ...
                               		-2*(1-sigma)*RR*GC2Pxx + N2C*GC2Pxx];
