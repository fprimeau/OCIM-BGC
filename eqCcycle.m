...
% beta
	...
	% Cell model only
		...
		if (par.opt_PStor_rCutoff)
			C2P_rCutoff_rCutoff = par.CellOut.d2C2P_rPCutoff2(iwet);
            kk = kk + 1;
            tmp = par.BIO.PStor_rCutoff*[-(I+(1-sigma)*RR)*(G*(C2P_rCutoff+par.BIO.PStor_rCutoff*C2P_rCutoff_rCutoff)); ...
                      (1-sigma)*G*(C2P_rCutoff+par.BIO.PStor_rCutoff*C2P_rCutoff_rCutoff); ...
                      sigma*G*(C2P_rCutoff+par.BIO.PStor_rCutoff*C2P_rCutoff_rCutoff); ...
                      (1-sigma)*RR*(G*(C2P_rCutoff+par.BIO.PStor_rCutoff*C2P_rCutoff_rCutoff)); ...
                      -2*(1-sigma)*RR*(G*(C2P_rCutoff+par.BIO.PStor_rCutoff*C2P_rCutoff_rCutoff)) + ...
                      N2C*G*(C2P_rCutoff+par.BIO.PStor_rCutoff*C2P_rCutoff_rCutoff)];
