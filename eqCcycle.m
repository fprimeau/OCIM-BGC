...
% unpack some useful stuff
    ...
    elseif (par.optim & nargout > 2)
		...
		if (par.opt_PLip_PCutoff == on)
			...
			dPCutoff_lPLip_PCutoff = par.BIO.PLip_PCutoff;
			tmp = dPCutoff_lPLip_PCutoff*[-(I+(1-sigma)*RR)*(G*C2P_PCutoff); ...
		...
		if (par.opt_PLip_scale == on)
			...
			dPLipscale_lPLip_scale = par.BIO.PLip_scale;
			tmp = dPLipscale_lPLip_scale*[-(I+(1-sigma)*RR)*(G*C2P_PLipscale); ...
		...
		if (par.opt_PStor_rCutoff == on)
			...
			drCutoff_lPStor_rCutoff = par.BIO.PStor_rCutoff;
			tmp = drCutoff_lPStor_rCutoff*[-(I+(1-sigma)*RR)*(G*C2P_rCutoff); ...
		...
		if (par.opt_PStor_scale == on)
			...
			dPStorscale_lPStor_scale = par.BIO.PStor_scale;
			tmp = dPStorscale_lPStor_scale*[-(I+(1-sigma)*RR)*(G*C2P_PStorscale); ...
 ...
 % sigma + Cell model params
		...
		if (par.opt_sigma & par.opt_PLip_PCutoff)
			...
			tmp = tmp*dPCutoff_lPLip_PCutoff; 	% dPCutoff_lPLip_PCutoff = par.BIO.PLip_PCutoff
		...
		if (par.opt_sigma & par.opt_PLip_scale)
        	kk = kk + 1;
			dC2Ptmp = C2P_PLipscale *dPLipscale_lPLip_scale; % dPLipscale_lPLip_scale = par.BIO.PLip_scale
		...
		if (par.opt_sigma & par.opt_PStor_rCutoff)
        	kk = kk + 1;
			dC2Ptmp = C2P_rCutoff * drCutoff_lPStor_rCutoff; % drCutoff_lPStor_rCutoff = par.BIO.PStor_rCutoff
			tmp = [RR*sigma*G*dC2Ptmp; ...
                      -sigma*G*dC2Ptmp; ...
                      sigma*G*dC2Ptmp; ...
                      -RR*sigma*G*dC2Ptmp; ...
		...
		if (par.opt_sigma & par.opt_PStor_scale)
        	kk = kk + 1;
			dC2Ptmp = C2P_PStorscale * dPStorscale_lPStor_scale; % dPStorscale_lPStor_scale = par.BIO.PStor_scale
			tmp = [RR*sigma*G*dC2Ptmp; ...
                      -sigma*G*dC2Ptmp; ...
                      sigma*G*dC2Ptmp; ...
                      -RR*sigma*G*dC2Ptmp; ...
...
%kP_T
	...
	% kP_T + cell model
		...
		if (par.opt_kP_T & par.opt_PLip_PCutoff)
			kk = kk + 1;
			dC2Ptmp = C2P_PCutoff * dPCutoff_lPLip_PCutoff;
            tmp = [-d0((I+(1-sigma)*RR)*Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      (1-sigma)*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      sigma*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      d0((1-sigma)*RR*Gx(:,pindx.kP_T))*dC2Ptmp; ...
		...
		if (par.opt_kP_T & par.opt_PLip_scale)
			kk = kk + 1;
			dC2Ptmp = C2P_PLipscale * dPLipscale_lPLip_scale;
            tmp = [-d0((I+(1-sigma)*RR)*Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      (1-sigma)*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      sigma*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      d0((1-sigma)*RR*Gx(:,pindx.kP_T))*dC2Ptmp; ...
		...
		if (par.opt_kP_T & par.opt_PStor_rCutoff)
			kk = kk + 1;
			dC2Ptmp = C2P_rCutoff * drCutoff_lPStor_rCutoff;
            tmp = [-d0((I+(1-sigma)*RR)*Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      (1-sigma)*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      sigma*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      d0((1-sigma)*RR*Gx(:,pindx.kP_T))*dC2Ptmp; ...
		...
		if (par.opt_kP_T & par.opt_PStor_scale)
			kk = kk + 1;
			dC2Ptmp = C2P_PStorscale * dPStorscale_lPStor_scale;
            tmp = [-d0((I+(1-sigma)*RR)*Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      (1-sigma)*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      sigma*d0(Gx(:,pindx.kP_T))*dC2Ptmp; ...
                      d0((1-sigma)*RR*Gx(:,pindx.kP_T))*dC2Ptmp; ...
...
% insert rR + cell model params here?
	...
	%%%%%%%%%%%% Cell model only %%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if (par.opt_Q10Photo & par.opt_PLip_PCutoff)
			...
			dC2Ptmp = C2P_PCutoff_lQ10 *dPCutoff_lPLip_PCutoff;
            kk = kk + 1;
			tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_Q10Photo & par.opt_PLip_scale)
			...
			dC2Ptmp = C2P_PLipscale_lQ10 *dPLipscale_lPLip_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_Q10Photo & par.opt_PStor_rCutoff)
			...
			dC2Ptmp = C2P_rCutoff_lQ10 * drCutoff_lPStor_rCutoff;
            kk = kk + 1;
			tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_Q10Photo & par.opt_PStor_scale)
			...
			dC2Ptmp = C2P_PStorscale_lQ10 * dPStorscale_lPStor_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_fStorage & par.opt_PLip_PCutoff)
			...
			dC2Ptmp = C2P_PCutoff_lfStor * dPCutoff_lPLip_PCutoff;
            kk = kk + 1;
			tmp = [-(I+(1-sigma)*RR)*(G*(dC2Ptmp)); ...
                      (1-sigma)*G*(dC2Ptmp); ...
                      sigma*G*(dC2Ptmp); ...
        ...
        if (par.opt_fStorage & par.opt_PLip_scale)
			...
			dC2Ptmp = C2P_PLipscale_lfStor * dPLipscale_lPLip_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_fStorage & par.opt_PStor_rCutoff)
			...
			dC2Ptmp = C2P_rCutoff_lfStor * drCutoff_lPStor_rCutoff;
            kk = kk + 1;
			tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_fStorage & par.opt_PStor_scale)
			...
			dC2Ptmp = C2P_PStorscale_lfStor * dPStorscale_lPStor_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_fRibE & par.opt_PLip_PCutoff)
			...
			dC2Ptmp = C2P_PCutoff_tfRibE * dPCutoff_lPLip_PCutoff;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_fRibE & par.opt_PLip_scale)
			...
			dC2Ptmp = C2P_PLipscale_tfRibE * dPLipscale_lPLip_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_fRibE & par.opt_PStor_rCutoff)
			...
			dC2Ptmp = C2P_rCutoff_tfRibE * drCutoff_lPStor_rCutoff;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_fRibE & par.opt_PStor_scale)
			...
			dC2Ptmp = C2P_PStorscale_tfRibE * dPStorscale_lPStor_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_PLip_PCutoff)
			...
			dC2Ptmp = C2P_PCutoff * d2PCutoff_lPCutoff + C2P_PCutoff_lPCutoff * dPCutoff_lPLip_PCutoff;
        ...
        if (par.opt_PLip_PCutoff & par.opt_PLip_scale)
            ...
            dC2Ptmp = C2P_PLipscale_lPCutoff * dPLipscale_lPLip_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_PLip_PCutoff & par.opt_PStor_rCutoff)
            ...
            dC2Ptmp = C2P_rCutoff_lPCutoff *drCutoff_lPStor_rCutoff;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_PLip_PCutoff & par.opt_PStor_scale)
			...
			dC2Ptmp = C2P_PStorscale_lPCutoff * dPStorscale_lPStor_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_PLip_scale)
			...
			dC2Ptmp = C2P_PLipscale * d2PLipscale_lPLipscale + C2P_PLipscale_lPLipscale * dPLipscale_lPLip_scale;
			% dC2Ptmp = d/dlogX[dC2P/dX *dX/dlogX]
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*(dC2Ptmp)); ...
                      (1-sigma)*G*(dC2Ptmp); ...
        ...
        if (par.opt_PLip_scale & par.opt_PStor_rCutoff)
			...
			dC2Ptmp = C2P_rCutoff_lPLipscale * drCutoff_lPStor_rCutoff;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
        ...
        if (par.opt_PLip_scale & par.opt_PStor_scale)
			...
			dC2Ptmp = C2P_PStorscale_lPLipscale * dPStorscale_lPStor_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_PStor_rCutoff)
			...
			dC2Ptmp = C2P_rCutoff * d2rCutoff_lrCutoff + C2P_rCutoff_lrCutoff * drCutoff_lPStor_rCutoff;
			% dC2Ptmp = d/dlogX[dC2P/dX *dX/dlogX]
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*(dC2Ptmp)); ...
                      (1-sigma)*G*(dC2Ptmp); ...
		...
		if (par.opt_PStor_rCutoff & par.opt_PStor_scale)
			...
			dC2Ptmp = C2P_PStorscale_lrCutoff * dPStorscale_lPStor_scale;
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*dC2Ptmp); ...
                         (1-sigma)*G*dC2Ptmp; ...
                         sigma*G*dC2Ptmp; ...
		...
		if (par.opt_PStor_scale)
			...
			dC2Ptmp = C2P_PStorscale * d2PStorscale_lPStorscale + C2P_PStorscale_lPStorscale * dPStorscale_lPStor_scale;
			% dC2Ptmp = d/dlogX[dC2P/dX *dX/dlogX]
            kk = kk + 1;
            tmp = [-(I+(1-sigma)*RR)*(G*(dC2Ptmp)); ...
                      (1-sigma)*G*(dC2Ptmp); ...
