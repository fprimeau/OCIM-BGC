...
elseif (par.optim & nargout > 3);
    ...
    if (par.opt_kP_T & par.opt_cc)
        kk = kk + 1;
        tmp = cc*[-(1+RR)*d0(Gx(:,pindx.kP_T))*dC2Pdcc; ...
                  (1-sigma)*d0(Gx(:,pindx.kP_T))*dC2Pdcc; ...
                  sigma*d0(Gx(:,pindx.kP_T))*dC2Pdcc; ...
                  RR*d0(Gx(:,pindx.kP_T))*dC2Pdcc];
    ...
    if (par.opt_kP_T & par.opt_dd)
        kk = kk + 1;
        tmp = dd*[-(1+RR)*d0(Gx(:,pindx.kP_T))*dC2Pddd; ...
                  (1-sigma)*d0(Gx(:,pindx.kP_T))*dC2Pddd; ...
                  sigma*d0(Gx(:,pindx.kP_T))*dC2Pddd; ...
                  RR*d0(Gx(:,pindx.kP_T))*dC2Pddd];
    ...
    if (par.opt_kdP & par.opt_cc)
        kk  = kk + 1;
        tmp = cc*[-(1+RR)*d0(Gx(:,pindx.lkdP))*dC2Pdcc; ...
                  (1-sigma)*d0(Gx(:,pindx.lkdP))*dC2Pdcc; ...
                  sigma*d0(Gx(:,pindx.lkdP))*dC2Pdcc; ...
                  RR*d0(Gx(:,pindx.lkdP))*dC2Pdcc];
    ...
    if (par.opt_kdP & par.opt_dd)
        kk  = kk + 1;
        tmp = dd*[-(1+RR)*d0(Gx(:,pindx.lkdP))*dC2Pddd; ...
                  (1-sigma)*d0(Gx(:,pindx.lkdP))*dC2Pddd; ...
                  sigma*d0(Gx(:,pindx.lkdP))*dC2Pddd; ...
                  RR*d0(Gx(:,pindx.lkdP))*dC2Pddd];
